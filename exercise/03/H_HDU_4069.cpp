			...
			for(j = 0; j < 9; j++)
			{
				if(mp[i][j].num == 0)
				{
					for(k = 0; k < 9; k++)
					{
						...
						y[row] = j;
						num[row] = k + 1;
						// printf("(%d,%d) ", row, i * 9 + j + 1);
						// printf("(%d,%d) ", row, 81 + i * 9 + k + 1);
						// printf("(%d,%d) ", row, 162 + j * 9 + k + 1);
						// printf("(%d,%d)\n", row, 243 + (mp[i][j].grp - 1) * 9 + k + 1);
						// colf[i * 9 + j + 1] = colf[81 + i * 9 + k + 1] = colf[162 + j * 9 + k + 1] = colf[243 + (mp[i][j].grp - 1) * 9 + k + 1] = 1;
						row++;
					}
				}
				else
...
/*
4
144 16 48 144 16 48 144 16 48
128 0 32 128 0 32 128 0 32
192 64 96 192 64 96 192 64 96
144 16 48 144 16 48 144 16 48
128 0 32 128 0 32 128 0 32
192 64 96 192 64 96 192 64 96
144 16 48 144 16 48 144 16 48
